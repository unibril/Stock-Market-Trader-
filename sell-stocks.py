    ...
    if result:
        ...
        if confirmation.lower() == "yes":
            ...
            if number_of_stocks > quantity:
                ...
                cursor.execute("UPDATE financial_details SET sell_price = %s, quantity = %s WHERE ticker = %s AND user_id = %s", (simulated_selling_price, quantity - number_of_stocks, stock, user_id))
                conn.commit()
                ...
                if quantity - number_of_stocks == 0:
